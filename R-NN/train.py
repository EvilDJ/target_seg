...
tf.flags.DEFINE_integer('num_seqs', 10, 'number of seqs in one batch')
tf.flags.DEFINE_integer('num_steps', 10, 'length of one seq')
...
tf.flags.DEFINE_string('input_file', 'F:\pycharm_代码\R-NN\data\poetry.txt', 'utf8 encoded text file')

...
class DetectionTargetLayer(KE.Layer):
    ...
    def compute_mask(self, inputs, mask=None): return [None, None, None, None]
...
#######################时间长-----------------------
        detections, _, _, mrcnn_mask, _, _, _ =\
            self.keras_model.predict([molded_images, image_metas, anchors], verbose=0)#keras_model.predict不懂
        # Process detections
        results = []

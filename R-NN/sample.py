...
tf.flags.DEFINE_string('converter_path', 'F:/pycharm_代码/R-NN/model/default/converter.pkl', 'model/name/converter.pkl')
tf.flags.DEFINE_string('checkpoint_path', 'F:/pycharm_代码/R-NN/model/default/model-1000', 'checkpoint path')
